...
var desk = require('./desk-e212f62d.js');
...
function DocumentInspectorPanel(props) {
  ...
  if (features.resizablePanes) {
    return /* @__PURE__ */jsxRuntime.jsx(desk.Resizable, {
      as: "aside",
      "data-ui": "DocumentInspectorPanel",
      flex,
      maxWidth: desk.DOCUMENT_INSPECTOR_MAX_WIDTH,
      minWidth: desk.DOCUMENT_INSPECTOR_MIN_WIDTH,
      children: element
    });
  }
...
function getWaitMessages(path) {
  ...
  return rxjs.merge(...thresholds.map(_ref9 => {
    let {
      ms,
      message
    } = _ref9;
...
const Content = styled__default.default(ui.Flex)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  opacity: 0;\n  transition: opacity 200ms;\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n"])));
const LoadingPane = React.memo(props => {
  ...
  const content = /* @__PURE__ */jsxRuntime.jsxs(Content, {
    align: "center",
...
const JSONInspectorWrapper = styled__default.default.div(_ref12 => {
  let {
    theme
  } = _ref12;
  const {
...
const Root$2 = styled__default.default(ui.Card)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
const TextOneLine = styled__default.default(ui.Text)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  & > * {\n    overflow: hidden;\n    overflow: clip;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n"])));
const ReferenceChangedBanner = React.memo(() => {
  ...
  const referenceInfo = reactRx.useMemoObservable(() => {
    ...
    operators.debounceTime(750), operators.map(_ref13 => {
      let {
        draft,
        published
      } = _ref13;
...
const Root$1 = styled__default.default(ui.Card)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Container, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(sanity.PresenceOverlay, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
        ...
        }) : /* @__PURE__ */jsxRuntime.jsx(desk.Delay, {
          ms: 300,
          children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
            align: "center",
            direction: "column",
...
const DocumentPanelHeader = React.memo(React.forwardRef(function DocumentPanelHeader2(_props, ref) {
  const {
    onMenuAction,
    onPaneClose,
    onPaneSplit,
  ...
  } = sanity.useFieldActions();
  const menuNodes = React.useMemo(() => desk.resolveMenuNodes({
    actionHandler: onMenuAction,
    fieldActions,
    menuItems,
    menuItemGroups
  }), [onMenuAction, fieldActions, menuItemGroups, menuItems]);
  const menuButtonNodes = React.useMemo(() => menuNodes.filter(desk.isMenuNodeButton), [menuNodes]);
  const contextMenuNodes = React.useMemo(() => menuNodes.filter(desk.isNotMenuNodeButton), [menuNodes]);
  ...
  return /* @__PURE__ */jsxRuntime.jsx(desk.PaneHeader, {
    ...
    subActions: /* @__PURE__ */jsxRuntime.jsx(desk.TimelineMenu, {
      chunk: rev,
      mode: "rev",
      placement: "bottom-end"
    }),
    actions: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
      align: "center",
      gap: 1,
      ...
      }), menuButtonNodes.map(item => /* @__PURE__ */jsxRuntime.jsx(desk.PaneHeaderActionButton, {
        node: item
      }, item.key)), /* @__PURE__ */jsxRuntime.jsx(desk.PaneContextMenuButton, {
        nodes: contextMenuNodes
      }, "context-menu"), showSplitPaneButton && /* @__PURE__ */jsxRuntime.jsx(ui.Tooltip, {
      ...
      }), showSplitPaneCloseButton && /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
        icon: icons.CloseIcon,
        mode: "bleed",
        onClick: onPaneClose,
...
const Scroller = styled__default.default(sanity.ScrollContainer)(_ref15 => {
  let {
    $disabled
  } = _ref15;
  if ($disabled) {
...
const DocumentPanel = function DocumentPanel2(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/* @__PURE__ */jsxRuntime.jsx(DocumentPanelHeader, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
        height: "fill",
        children: [(features.resizablePanes || !showInspector) && /* @__PURE__ */jsxRuntime.jsx(DocumentBox, {
          flex: 2,
          overflow: "hidden",
          children: /* @__PURE__ */jsxRuntime.jsx(ui.PortalProvider, {
            ...
            children: /* @__PURE__ */jsxRuntime.jsx(ui.BoundaryElementProvider, {
              ...
              children: /* @__PURE__ */jsxRuntime.jsxs(sanity.VirtualizerScrollInstanceProvider, {
        ...
        }), showInspector && /* @__PURE__ */jsxRuntime.jsx(ui.BoundaryElementProvider, {
          element: rootElement,
          children: /* @__PURE__ */jsxRuntime.jsx(DocumentInspectorPanel, {
            documentId,
...
function DocumentActionPortalProvider(props) {
  ...
  const portalElement = (elements == null ? void 0 : elements[desk.DOCUMENT_PANEL_PORTAL_ELEMENT]) || element;
  return /* @__PURE__ */jsxRuntime.jsx(ui.PortalProvider, {
    element: portalElement,
    children
  });
}
function ActionStateDialog(props) {
  ...
  if (dialog.type === "dialog" || !dialog.type) {
    return /* @__PURE__ */jsxRuntime.jsx(DocumentActionPortalProvider, {
      children: /* @__PURE__ */jsxRuntime.jsx(ModalDialog, {
        dialog
      })
    });
  }
...
const Root = styled__default.default(ui.Flex)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  cursor: default;\n"])));
...
const StyledMotionPath = styled__default.default(framerMotion.motion.path)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  transform-origin: center;\n"])));
...
const rotateAnimation = styled.keyframes(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  0% {\n    transform: rotate(0);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n"])));
const RotateGroup = styled__default.default.g(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n  transform-origin: center;\n\n  &[data-rotate] {\n    animation: ", " 1s ease-in-out infinite;\n  }\n"])), rotateAnimation);
const root = {
  syncing: {
    scale: 1,
    transition: {
...
const DocumentActionsBox = styled__default.default(ui.Box)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n  min-width: 10em;\n  max-width: 16em;\n"])));
...
function KeyboardShortcutResponder(props) {
  ...
  return React.createElement(as, {
    ...
    ...rest,
    ref: rootRef
  }, [children, activeAction && activeAction.dialog && /* @__PURE__ */jsxRuntime.jsx(sanity.LegacyLayerProvider, {
    zOffset: "paneFooter",
    children: /* @__PURE__ */jsxRuntime.jsx(ActionStateDialog, {
...
"absolute"];
const StyledChangeConnectorRoot = styled__default.default(sanity.ChangeConnectorRoot)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  min-height: 0;\n  min-width: 0;\n"])));
...
function DocumentPaneInner(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(desk.DocumentPaneProvider, {
    ...providerProps,
...
function InnerDocumentPane() {
  ...
  const currentMinWidth = desk.DOCUMENT_PANEL_INITIAL_MIN_WIDTH + (inspector ? desk.DOCUMENT_INSPECTOR_MIN_WIDTH : 0);
  const minWidth = desk.DOCUMENT_PANEL_MIN_WIDTH + (inspector ? desk.DOCUMENT_INSPECTOR_MIN_WIDTH : 0);
  if (!schemaType) {
    return /* @__PURE__ */jsxRuntime.jsx(ErrorPane, {
      currentMinWidth,
      flex: 2.5,
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(DocumentActionShortcuts, {
    actionsBoxElement,
    as: desk.Pane,
    currentMinWidth,
    ...
    children: [/* @__PURE__ */jsxRuntime.jsx(ui.DialogProvider, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(ui.Flex, {
        ...
        children: /* @__PURE__ */jsxRuntime.jsx(StyledChangeConnectorRoot, {
          "data-testid": "change-connector-root",
          isReviewChangesOpen: changesOpen,
          onOpenReviewChanges: onHistoryOpen,
          onSetFocus: onConnectorSetFocus,
          children: /* @__PURE__ */jsxRuntime.jsx(DocumentPanel, {
    ...
    }), /* @__PURE__ */jsxRuntime.jsx(ui.PortalProvider, {
      __unstable_elements: {
        [desk.DOCUMENT_PANEL_PORTAL_ELEMENT]: documentPanelPortalElement
      },
      children: /* @__PURE__ */jsxRuntime.jsx(ui.DialogProvider, {
        position: DIALOG_PROVIDER_POSITION,
        zOffset: zOffsets.portal,
...
const StyledPaneLayout = styled__default.default(PaneLayout)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
const isSaveHotkey = isHotkey__default.default("mod+s");
const DeskTool = React.memo(function DeskTool2(_ref21) {
  let {
    onPaneChange
  } = _ref21;
  var _a;
...
//# sourceMappingURL=index-864d1c98.js.map
