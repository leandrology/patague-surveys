...
async function getBuildAction() {
  const mod = await import('./buildAction-b25ad6bb.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-453342b5.js');
...
async function getDevAction() {
  const mod = await import('./devAction-38ca13a5.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-16bbb69b.js');
  return mod.default;
}
...
const execCommand = {
  ...
  helpText: helpText$8,
  action: async (args, context) => {
    const mod = await import('./execScript-8b005ca4.js');
    return mod.default(args, context);
  }
};
const corsGroup = {
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-c93fe144.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-55c657cc.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deleteApiAction-267e04d4.js');
    return mod.default(args, context);
  },
  helpText: helpText$2
};
...
//# sourceMappingURL=_internal-757d0c6f.js.map
