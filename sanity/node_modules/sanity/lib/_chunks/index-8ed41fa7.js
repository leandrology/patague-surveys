...
import { useElementRect, Box, Card, Container, Heading, Stack, Label, Code, Text, Button, Flex, _raf2, Spinner, useToast, rem, TextInput, Dialog, TabList, Tab, TabPanel, focusFirstDescendant, Tooltip, usePortal, PortalProvider, BoundaryElementProvider, Popover, useLayer, useClickOutside, useGlobalKeyDown, Grid, MenuButton, Menu, MenuItem, Hotkeys, LayerProvider, Inline, Badge, DialogProvider, ErrorBoundary } from '@sanity/ui';
import { ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, PANE_DEFAULT_MIN_WIDTH, PANE_COLLAPSED_WIDTH, PaneLayoutContext, Root as Root$3, usePane, useDocumentPane, useDeskTool, Resizable, DOCUMENT_INSPECTOR_MAX_WIDTH, DOCUMENT_INSPECTOR_MIN_WIDTH, LOADING_PANE, SerializeError, Pane, PaneHeader, PaneContent, DocTitle, usePaneRouter, Delay, resolveMenuNodes, isMenuNodeButton, isNotMenuNodeButton, TimelineMenu, PaneHeaderActionButton, PaneContextMenuButton, usePaneLayout, DOCUMENT_PANEL_PORTAL_ELEMENT, HistoryRestoreAction, DocumentPaneProvider, PaneFooter, DOCUMENT_PANEL_INITIAL_MIN_WIDTH, DOCUMENT_PANEL_MIN_WIDTH, setActivePanes, DeskToolProvider } from './desk-0917fc19.js';
...
import { GetHookCollectionState, isRecord, useDocumentStore, isDev, useDocumentOperationEvent, useSettingsStore, isString, useDocumentPreviewStore, getPublishedId, useCurrentUser, useDocumentPresence, createPatchChannel, PresenceOverlay, FormBuilder, fromMutationPatches, unstable_useValuePreview, useFieldActions, useTimelineSelector, ScrollContainer, VirtualizerScrollInstanceProvider, LegacyLayerProvider, useTimeAgo, useSyncState, ChangeConnectorRoot, useSource, SourceProvider, useDocumentType, useTemplatePermissions, ReferenceInputOptionsProvider, useTemplates, useZIndex, useSchema, _isCustomDocumentTypeDefinition, useWorkspace } from 'sanity';
import { generateHelpUrl } from '@sanity/generate-help-url';
import isEqual from 'lodash/isEqual.js';
import { useRouter, useRouterState } from 'sanity/router';
import { uuid } from '@sanity/uuid';
import styled, { css, keyframes } from 'styled-components';
import { SyncIcon, SearchIcon, WarningOutlineIcon, CloseIcon, ReadOnlyIcon, ArrowLeftIcon, SplitVerticalIcon, ChevronDownIcon, PlayIcon, PublishIcon } from '@sanity/icons';
...
const Content = styled(Flex)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  opacity: 0;\n  transition: opacity 200ms;\n\n  &[data-mounted] {\n    opacity: 1;\n  }\n"])));
...
const paneMap = {
  component: lazy(() => import('./index-8835ce52.js')),
  document: lazy(() => import('./index-bb78bf76.js')),
  documentList: lazy(() => import('./index-8758d7a4.js')),
  list: lazy(() => import('./index-58d49cae.js'))
};
...
const Root$2 = styled(Card)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
const TextOneLine = styled(Text)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  & > * {\n    overflow: hidden;\n    overflow: clip;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n"])));
...
const Root$1 = styled(Card)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  position: relative;\n  z-index: 50;\n"])));
...
const Scroller = styled(ScrollContainer)(_ref15 => {
  let {
    $disabled
  } = _ref15;
  if ($disabled) {
...
const StyledPaneLayout = styled(PaneLayout)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
const isSaveHotkey = isHotkey("mod+s");
const DeskTool = memo(function DeskTool2(_ref21) {
  let {
    onPaneChange
  } = _ref21;
  var _a;
...
//# sourceMappingURL=index-8ed41fa7.js.map
