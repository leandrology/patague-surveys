...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-1ed05783.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-e11ef2f0.js');
    });
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-a8029034.js');
  });
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-ef26f759.js');
  });
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-5dad761c.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-c1cf5513.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deleteApiAction-9aec11d3.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$2
...
//# sourceMappingURL=_internal-07726c94.js.map
