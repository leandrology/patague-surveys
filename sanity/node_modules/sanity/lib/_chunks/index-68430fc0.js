...
var index = require('./index-864d1c98.js');
var PathUtils = require('@sanity/util/paths');
var types = require('@sanity/types');
var PaneItem = require('./PaneItem-922a6813.js');
...
const RootBox = styled__default.default(ui.Box)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: relative;\n"])));
const CommandListBox = styled__default.default(ui.Box)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n"])));
...
function listenSearchQuery(options) {
  ...
  return rxjs.merge(welcome$.pipe(rxjs.take(1)), mutationAndReconnect$.pipe(rxjs.throttleTime(1e3, rxjs.asyncScheduler, {
    leading: true,
    trailing: true
  }))).pipe(rxjsExhaustmapWithTrailing.exhaustMapWithTrailing(() => {
...
const EMPTY_ARRAY = [];
const rotate = styled.keyframes(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
const AnimatedSpinnerIcon = styled__default.default(icons.SpinnerIcon)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  animation: ", " 500ms linear infinite;\n"])), rotate);
const SearchCard = styled__default.default(ui.Card)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  [data-ui='TextInput'] {\n    border-radius: inherit;\n  }\n"])));
...
//# sourceMappingURL=index-68430fc0.js.map
