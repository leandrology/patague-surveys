...
/** @internal */
export declare function FieldActionsProvider(
...
export declare interface FormFieldProps {
   ...
   * @beta
   */
  __unstable_headerActions?: React_2.ReactNode
  /**
   * @beta
   */
  validation?: FormNodeValidation[]
...
/** @internal */
export declare function HoveredFieldProvider(props: PropsWithChildren): JSX.Element
