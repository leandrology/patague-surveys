...
declare interface BaseDeskToolPaneProps<T extends PaneNode['type']> {
  paneKey: string
  index: number
  itemId: string
  childItemId?: string
 ...
 * @internal
 */
export declare const DocumentPaneProvider: React_2.MemoExoticComponent<
...
export {MenuItem as DeskToolMenuItem}
export {MenuItem}
...
/** @internal */
export declare function useDeskTool(): DeskToolContextValue
